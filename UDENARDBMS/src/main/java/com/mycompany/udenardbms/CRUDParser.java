...
public class CRUDParser {
    ...
    public static StringBuilder parser(String sql) throws JSQLParserException {
        ...
        if (stmt instanceof CreateTable) {
            ...
            fm.closeTableSchema();
            return new StringBuilder("Tabla " + tablename + " creada con éxito");
            ...
            return new StringBuilder("Insert en la tabla " + tablename + " exitoso");
            ...
            return fm.delete(tablename, where);
        } else if (stmt instanceof Alter) {
            Object[] result = (Object[]) Fuctionclass.ValueDefault(sql);
